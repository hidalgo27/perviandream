        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" name="txt_name_passenger" class="form-control font-weight-bold" id="txt_name_passenger" value="{{old('txt_name_passenger')}}">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label class="font-weight-bold text-secondary small" for="txt_email">Email</label>
                    <input type="email" name="txt_email" class="form-control font-weight-bold" id="txt_email" value="{{old('txt_email')}}">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="date" name="txt_date" class="form-control font-weight-bold" id="txt_date" value="{{old('txt_date')}}">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label class="font-weight-bold text-secondary small" for="txt_travellers">Travellers</label>
                    <input type="number" name="txt_travellers" class="form-control font-weight-bold" id="txt_travellers" value="{{old('txt_travellers')}}">
                </div>
            </div>
        </div>
