        ...
        <div class="table-wrapper m-0 p-0">
            ...
            <table class="table table-striped table-hover small table-sm font-weight-bold text-secondary">
                ...
                @foreach($tour as $tours)
                    @if ($tours->estado == 0)
                        @php $estado_tours = ""; @endphp
                    @else
                        @php $estado_tours = "checked"; @endphp
                    @endif
                    <tr>
                        <td>
                            <span class="custom-checkbox">
                        ...
                        <td>{{$tours->codigo}} </td>
                        <td><a href="{{route('admin_package_edit_path', $tours->id)}}">{{$tours->titulo}}</a></td>
                        <td><input type="checkbox" {{$estado_tours}} data-toggle="toggle" data-size="xs"></td>
                        {{--<td>(171) 555-2222</td>--}}
                        <td class="text-center">
                            <a href="{{route('admin_package_edit_path', $tours->id)}}" class="edit"><span data-feather="edit-3"></span></a>
                            <a href="#delete_package_{{$tours->id}}" class="delete" data-toggle="modal"><span data-feather="trash"></span></a>
                        </td>
                    </tr>
                    <div id="delete_package_{{$tours->id}}" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{route('admin_package_delete_path', $tours->id)}}" method="post">
                                    @method('DELETE')
                                    @csrf
