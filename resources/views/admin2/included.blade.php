    ...
    @if (session('status'))
        <div class="toast bg-primary fixed-top" role="alert" aria-live="polite" aria-atomic="true" data-delay="10000" style="left: auto; top: 55px; right: 10px;">
            <div class="toast-header">
                ...
                <strong class="mr-auto">Included</strong>
                <small>
                    @php
    ...
    <div class="">
        <div class="table-wrapper m-0 p-0">
            <div class="table-title m-0">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Manage <b>Included</b></h2>
                    </div>
                    <div class="col-sm-6">
                        <a href="#addIncluded" class="btn btn-success" data-toggle="modal"><span data-feather="plus-circle"></span> Add New Included</a>
            ...
            <div id="addIncluded" class="modal fade">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <form action="{{route('admin_included_store_path')}}" method="post">
                            @csrf
                            <div class="modal-header">
                                <h4 class="modal-title">Add Included</h4>
                    ...
                    @foreach($included1 as $included2)
                        ...
                        <div id="delete_included_{{$included2->id}}" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{route('admin_included_delete_path', $included2->id)}}" method="post">
                                        @method('DELETE')
                                        @csrf
                                        <div class="modal-header">
                        ...
                        <div id="edit_included_{{$included2->id}}" class="modal fade">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <form action="{{route('admin_included_update_path', $included2->id)}}" method="post">
                                        @csrf
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Included</label>
                                                <input type="text" class="form-control" name="txt_included" required value="{{$included2->incluye}}">
                                            </div>
                                            @php
